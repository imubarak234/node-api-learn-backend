...
// Required data: phone
// Optional data: none
// @TODO Only let an authenticated user access their object. Don't allow access to other user objects
...
// @TODO only let an authenticated user update their own object. Don't allow them update another
...
handlers._tokens.verifyToken = function(id, phone, callback){
  ...
  _data.read('tokens', id, function(err, tokenData){
    if(!err && tokenData){
      ...
      if(tokenData.phone  == phone && tokenData.expires > DataTransfer.now()){
        callback(true);
      }
      else {
        callback(false);
