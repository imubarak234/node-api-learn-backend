...
workers.performCheck = function(originalCheckData){
  ...
  let path = parsedUrl.path; // Using path and "pathName" because we want the query string

  console.log("This is what the hostname looks like: " + hostName)
...
workers.rotateLogs = function(){
  ...
  _logs.list(false, function(err, logs){
    if(!err && logs && logs.length > 0){
      ...
      console.log("Error : could not find any logas to rotate");
    }
  });
};
